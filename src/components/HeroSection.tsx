  ...
  return (
    <section className="bg-gray-900 text-white text-center py-20 px-4">
      <motion.div variants={container} initial="hidden" animate="show">
        <motion.h1 variants={item} className="text-5xl md:text-6xl font-extrabold leading-tight mb-4 text-balance">
          Revolutionary Blockchain-Powered Green Hydrogen Subsidies
        </motion.h1>
        <motion.p variants={item} className="text-xl md:text-2xl max-w-4xl mx-auto text-gray-300 mb-8">
        ...
        <motion.div variants={item} className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto mb-10 text-lg">
        ...
        <motion.div variants={item} className="flex flex-col sm:flex-row justify-center items-center gap-4">
          ...
          <motion.a
            ...
            className="bg-gold text-gray-900 font-bold py-3 px-8 rounded-lg text-lg hover:bg-gold-dark transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-electric-green focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900"
          >
            Download Whitepaper
          </motion.a>
        </motion.div>
