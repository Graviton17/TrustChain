...
const TrustChainProjectForm = () => {
  ...
  const validateStep = (stepIndex) => {
    ...
    switch (stepIndex) {
      case 0: // Project Info
        if (!stepData.companyId) stepErrors.companyId = 'Company ID is required';
        if (!stepData.project_name) stepErrors.project_name = 'Project name is required';
        break;
  ...
  const renderStepContent = () => {
    ...
    const stepErrors = errors[steps[currentStep].id] || {};
      ...
      case 0:
        return (
          <ProjectInformationForm
            ...
            updateData={(field, value) => updateFormData('project', field, value)}
            errors={stepErrors}
          />
        );
      case 1:
        return (
          <ComplianceForm
            data={currentStepData}
            updateData={(field, value) => updateFormData('compliance', field, value)}
            errors={stepErrors}
          />
        );
      case 2:
        return (
          <FinancialsForm
            data={currentStepData}
            updateData={(field, value) => updateFormData('financials', field, value)}
            errors={stepErrors}
          />
        );
      case 3:
        return (
          <ProductionForm
            data={currentStepData}
            updateData={(field, value) => updateFormData('production', field, value)}
            errors={stepErrors}
          />
        );
      case 4:
        return (
          <VerificationForm
            data={currentStepData}
            updateData={(field, value) => updateFormData('verification', field, value)}
            errors={stepErrors}
          />
        );
      default:
              ...
              <div className="mt-8 text-center">
                <button
                  onClick={() => {
                    ...
                    setCurrentStep(0);
                    setFormData({
                      project: { companyId: '', project_name: '', sector: '', location: '', ownership_type: '', start_year: '', completion_year: '', selected_subsidy: '' },
                      compliance: { env_clearance_status: '', lca_completed: false, mrv_plan: false },
                      financials: { capex: '', opex: '', offtake_signed: false },
                      production: { technology_used: '', electrolyzer_type: '', installed_capacity_mw: '', hydrogen_output_tpy: '' },
                      verification: { carbon_intensity: '', renewable_source: '', additionality_proof: false }
                    });
                  }}
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-emerald-50">
      ...
      <div className="bg-white py-12 border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Green Hydrogen Project Registration</h2>
          <p className="text-lg text-gray-600 mb-8">Complete your project registration in 5 comprehensive steps</p>
          
          {/* Progress Section */}
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <div className="flex items-center justify-between mb-4">
              <span className="text-sm font-semibold text-gray-700">Registration Progress</span>
              <span className="text-sm font-bold text-emerald-600">{currentStep + 1} of {steps.length}</span>
            </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="mb-8">
              <div className="flex items-center space-x-3 mb-4">
                <div className="w-12 h-12 bg-emerald-100 rounded-xl flex items-center justify-center">
                  {React.createElement(steps[currentStep].icon, { className: "w-6 h-6 text-emerald-600" })}
                </div>
                <div>
                  ...
                  <p className="text-gray-600">
                    {currentStep === 0 && "Enter basic project information and company details"}
                    {currentStep === 1 && "Provide compliance and regulatory information"}
                    {currentStep === 2 && "Add financial details and investment information"}
                    {currentStep === 3 && "Specify production capacity and technology details"}
                    {currentStep === 4 && "Complete verification and certification requirements"}
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center p-6 bg-white rounded-xl border border-gray-100 hover:shadow-lg hover:border-emerald-200 transition-all duration-300 group">
            ...
            <h4 className="font-semibold text-gray-900 mb-2">100% Blockchain Transparency</h4>
            <p className="text-sm text-gray-600">Every transaction recorded immutably on blockchain</p>
          </div>
          ...
          <div className="text-center p-6 bg-white rounded-xl border border-gray-100 hover:shadow-lg hover:border-emerald-200 transition-all duration-300 group">
            ...
            <p className="text-sm text-gray-600">Automated smart contracts accelerate disbursements</p>
          </div>
          ...
          <div className="text-center p-6 bg-white rounded-xl border border-gray-100 hover:shadow-lg hover:border-emerald-200 transition-all duration-300 group">
            ...
            <h4 className="font-semibold text-gray-900 mb-2">Zero Fraud Guarantee</h4>
            <p className="text-sm text-gray-600">Immutable records prevent fraud and ensure compliance</p>
          </div>
        </div>
      </div>
    </div>
